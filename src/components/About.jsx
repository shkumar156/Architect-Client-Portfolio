...
const About = () => {
  const stats = [
    ...
    { icon: <Users className="w-8 h-8" />, value: '3+', label: 'Years Experience' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative z-10">
              <img
                src="/Images/CoverPhoto/1B3A6017.JPG"
                alt="Mughees Khan"
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-lg text-primary-600 mb-6 leading-relaxed">
                I'm Mughees Khan, a passionate Architect Engineer with over 3 years of experience 
