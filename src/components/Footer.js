      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-primary-300 mb-4 leading-relaxed">
              Architecture Engineer dedicated to creating innovative and sustainable 
        ...
        <div className="border-t border-primary-700 pt-8 mt-8">
          <div className="max-w-2xl mx-auto text-center">
            <h4 className="text-xl font-display font-semibold mb-4 text-white">
              Stay Updated
            </h4>
            <p className="text-primary-300 mb-6">
              Get insights into the latest architectural innovations and project updates.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-primary-800 border border-primary-700 rounded-lg text-white placeholder-primary-400 focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-accent-500"
              />
              <button className="bg-accent-500 hover:bg-accent-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              <a 
                href="#" 
                className="text-primary-400 hover:text-accent-400 transition-colors duration-300 text-sm"
              >
                Privacy Policy
              </a>
              <a 
